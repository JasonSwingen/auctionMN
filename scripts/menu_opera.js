...
var iconTag=(array[v13*3+2]?"<IMG SRC=\'"+f33(q.v21)+"/"+q.fnm+"ia.gif\' BORDER=0 WIDTH="+q.iconSize+" HEIGHT="+q.iconSize+" HSPACE=0 ALIGN=RIGHT>":"")
var v26=array[v13*3]
...
for(v13=0;v13<array.length/3;v13++){
if(array[v13*3+2])buildPopup(q,v12+'_'+(v13+1),level+1)}}
...
buildPopups()
function f03(q,popup,id,v27,v26,v30,v09,bLast,v31){
...
backgroundColor=q.bord?q.borderCol:v09[4]
borderWidth=q.bord
borderStyle="solid"}
...
for(v13=0;v13<array.length/3;v13++){
var v30=(array[v13*3+2])?(v12+"_"+parseInt(v13+1)):null
v31+=f03(q,popup,(popupName+v13),array[v13*3+1],array[v13*3],v30,v09,(v13==array.length/3-1),v31)}
return popup}
function f06(q,popupId,dl){
if(popupId.indexOf('_')==-1){
var hideWnd=findElement(q.v18,'HideItem')
...
if(popup.id.indexOf('_')==-1){var hideWnd=findElement(q.v18,'HideItem');if(hideWnd)hideWnd.style.visibility='hidden';}
